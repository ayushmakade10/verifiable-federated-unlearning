...
# Display order for the text table (low → high).
ASSURANCE_LEVELS = ["basic", "strong", "high"]

# Evaluation order: high FIRST so calibration includes all 5 checks.
# Basic/strong checks are subsets of high, so they find everything
# they need in the saved calibration.
EVALUATION_ORDER = ["high", "strong", "basic"]
